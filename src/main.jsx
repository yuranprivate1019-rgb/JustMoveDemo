...
function Header() { return <header className="header"><div className="brand"><span className="orb"><IconGlyph icon="🤖"/></span>JustMove.AI</div><nav><button>Book</button><button>Trips</button><button>Alerts</button><span className="profile"><IconGlyph icon="◉"/></span></nav></header>; }
